...
int main(int nargs, char* argv[])
{
    ...
    std::cout << "Encodage de l'image par DFT : " << elapsed_seconds.count() << "s" << std::endl;
    ...
    std::cout << "Selection des p% plus gros coefficients : " << elapsed_seconds.count() << "s" << std::endl;
    ...
    elapsed_seconds = end - start;
    std::cout << "Reconstitution de l'image compressee : " << elapsed_seconds.count() << "s" << std::endl;
